...
var template = function template(context) {
  return new _promise2.default(function (resolve) {
    resolve("\n      <h5 class=\"card-title\">Welcome to the Bennett Medica.</h5>\n      <div class=\"card-text\">\n      <Br><Br>  <p>We created this tool to help you help you diagnose yourself, with a level of certainity like never before, thanks to our new neural engine (powered by infermedica), that learns as you use it!; an application that mimics a doctor's interview and gives you a preliminary diagnosis based on our mathematical model.</p>\n    <Br><Br>    <p>   5 students, one guiding soul, one coffee shop and countless hours of work gets you something that could revolutionize the medical industry itself. we have partnered with real doctors to create a database so vast as to cover almost all- dieases and their cures with a scale of certainity, moreover we guide you towards the next step in your care, and what doctor to consult!                                                                                                                                                                                                                                                                                                                                                                            </p>\n        <p></p>\n       <BR><BR><BR><BR>        <p class=\"text-muted small\"><i class=\"fa fa-info-circle\"></i>Please note that the information provided by this tool is provided solely for educational purposes and is not a qualified medical opinion. This information should not be considered advice or an opinion of a doctor or other health professional about your actual medical state, and you should see a doctor for any symptoms you may have. If you are experiencing a health emergency, you should call your local emergency number immediately to request emergency medical assistance.</p>\n   <br>   <p>Please click <span class=\"badge badge-primary\">Next</span> to move to the first question.</p>\n </div>\n    ");
  });
};
...
var template = "\n  <div class=\"card\">\n      <div class=\"card-header\">\n          <i class=\"fa fa-user-md\"></i>Bennett Medica!<span class=\"d-none d-sm-block float-right text-muted\">powered by <a href=\"http://infermedica.com/\">Infermedica</a></span>\n      </div>\n      <div id=\"step-container\" class=\"card-block\">\n        <!-- dynamic content goes here -->\n      </div>\n      <div class=\"card-footer\">\n          <button id=\"next-step\" class=\"btn btn-primary float-right\">Next <i class=\"fa fa-chevron-right\"></i></button>\n      </div>\n  </div>\n";
